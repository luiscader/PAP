        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title">Contratar Fornecedor</h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="funcionarios.php">Fornecedor</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Contratar Fornecedor</li>
                        </ol>
                    </nav>
                </div>
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Funcionarios Disponíveis</h4>
                        <div class="row">
                            <div class="col-12">
