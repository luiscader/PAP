...
// Verifica se o tipo de utilizador é 'fornecedor'
if ($tipo !== 'fornecedor') {
    echo "Acesso restrito. Apenas fornecedores podem acessar esta página.";
    exit();
}
...
<body>
    <?php include 'sidebar_fornecedor.php'; ?> <!-- Inclui a sidebar -->
    <main>
        <!-- Conteúdo da página -->
    </main>
</body>
