...
(function (factory) {
  ...
  var DataTable = function (selector, options) {
     ...
     *  @param {string|int} mAction Paging action to take: "first", "Anterior", "Seguinte" or "last"
  ...
  function _fnLanguageCompat(lang) {
    ...
    if (lang) {
      ...
      if (
        !lang.sEmptyTable &&
        zeroRecords &&
        defaults.sEmptyTable === "Não existem dados disponíveis na tabela"
      ) {
   ...
   *    "Seguinte" or "last" or page number to jump to (integer)
  ...
  DataTable.defaults = {
     ...
     * (i.e. "A mostrar 1 to 10 of 57 items") DataTables will render large numbers
    ...
    oLanguage: {
       ...
       *
       *  @type string
       *  @default Showing _START_ to _END_ of _TOTAL_ z
       *
       *  @dtopt Language
       ...
       *      $('#example').dataTable( {
       *        "language": {
       *          "info": "A mostrar page _PAGE_ of _PAGES_"
       *        }
       *      } );
       *    } );
       */
      sInfo: "A mostrar _START_ a _END_ de _TOTAL_ items",
