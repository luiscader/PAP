  ...
  <ul class="nav">
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse" id="restaurante">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="restaurantes.php">Lista de Restaurantes</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item menu-items">
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse" id="fornecedor">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="fornecedores.php">Lista de Fornecedores</a></li>
        </ul>
      </div>
    </li>
    </li>
